...
var Slider = /*#__PURE__*/function () {
  function Slider() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        previousSelector = _ref$previousSelector === void 0 ? "#prevBtn" : _ref$previousSelector,
        _ref$nextSelector = _ref.nextSelector,
        nextSelector = _ref$nextSelector === void 0 ? "#nextBtn" : _ref$nextSelector,
        _ref$transitionTime = _ref.transitionTime,
        transitionTime = _ref$transitionTime === void 0 ? 3000 : _ref$transitionTime,
        _ref$autoPlayOn = _ref.autoPlayOn,
        autoPlayOn = _ref$autoPlayOn === void 0 ? false : _ref$autoPlayOn;
  ...
  _createClass(Slider, [{
    ...
    value: function moveSlides() {
      ...
      Array.from(this.pagers.children).forEach(function (pager) {
        return pager.classList.remove("active");
      });
    ...
    key: "setAutoPlay",
    value: function setAutoPlay(autoPlayOn, transitionTime) {
      if (autoPlayOn) {
        this.runAutoPlayInterval;
      }
    }
  }, {
    key: "clearlAutoPlayInterval",
    value: function clearlAutoPlayInterval() {
